...
class LibraryComponent extends React.Component {
    ...
    //     handleSelect(id) {
    //     switch (this.getFilteredData()[id].extensionId) {
    //         case "videoSensing":
    //             if (
    ...
    //                             return device.kind == 'videoinput' && !(device?.label?.toLowerCase().includes('virtual'))}
    //                         );
    //                         console.log('video inputs is ', videoInputs)
        ...
        return (
            ...
            >
                <WarningPopup
                    ...
                    message="This extension requires camera. Your camera is either not connected or the driver is not supported with the device."
